...
console.log( "I kilometri sono:" , elementKm.toFixed(2) , "km");
...
if(elementEta < 18) {
    ...
    console.log("Somma con sconto 20% ", elementSomma.toFixed(2), "€");
    ...
    console.log("Somma con sconto 40% ", elementSomma.toFixed(2), "€");

}

else{
    console.log("Somma", elementSomma.toFixed(2), "€");
}
